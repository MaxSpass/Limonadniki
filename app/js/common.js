    ...
    $('.btn-pre-order, .btn-callback').click(function() {
        ...
        $('.btn-array').click(function() {
            ...
            if (modalForm[0].checkValidity()) {
                $.post('/Post_Contact.php', modalForm.serializeArray(), function(data) {});
    ...
    $('#basket').click(function() {
        ...
        for (var i = 0; i < itemArray.length; i++) {
            ...
            $('<div class="offer-item clearfix">' +
                ...
                '<div class="offer-name">' + itemName + '</div><div class="offer-quan"><div class="number"><button class="minus" value="' + itemPrice + '">-</button><input type="text" value="1"/><button class="plus" value="' + itemPrice + '">+</button></div></div><div class="offer-price">' + itemPrice + '</div></div>').prependTo($('.offer-inner'))
        }
        ...
        $('.close-offer-box').click(function() {
